...
Чтобы залить проект на *GitHub* нужно проделать сделующие действия:
...
После вам нужно воспользоваться посказками __*GITHUB*__
...
* Вносим изменения
* Загружаем измененый репозитарий в скопированный проект в своем профиле на __*GITHUB*__
...
Для этого скопируем ссылку на cкопированный репозитарий
...
Главное правило создать нувую ветку в которой вы поместите коммит (коммиты) со всеми изменениями
...
Загружаем измененый репозитарий в скопированный проект в своем профиле на __*GITHUB*__ При помощи команды
